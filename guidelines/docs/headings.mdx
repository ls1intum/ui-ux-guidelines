...
import RedirectIcon from './assets/seo-meta-header-example.png';
...
<Image src={RedirectIcon} alt={"Example of a good heading structure shown in the SEO META in 1 CLICK tool"} />
...
[//]: # (    alt={"Example of a good heading structure shown in the SEO META in 1 CLICK tool"})

[//]: # (    aria-label={"Example of a good heading structure shown in the SEO META in 1 CLICK tool"})
